package com.werisetech.weriseapp.online
...
object OverpassRefresher {
    ...
    private fun elementToService(el: JSONObject): Service? {
        ...
        val phone = tags.optString("phone").ifBlank { tags.optString("contact:phone") }.ifBlank { null }
    ...
    private fun composeAddress(tags: JSONObject): String {
        ...
        val streetPart = listOf(parts.getOrNull(0), parts.getOrNull(1)).filterNotNull().joinToString(" ")
    ...
    private data class BoundingBox(val south: Double, val west: Double, val north: Double, val east: Double)
